...
class DatabaseManager {
  ...
  private seedData() {
    ...
    const seedSQL = `
      ...
      ('pat-1', 'Богданов Марк Егорович', '1985-05-15', 'Мужчина', 'bogdanov@email.com', 'ward-1', 'emp-1', '2025-06-15', 'dis-1'),
      ('pat-2', 'Климов Александр Владиславович', '1990-08-22', 'Мужчина', 'klimov@email.com', 'ward-1', 'emp-2', '2025-06-16', 'dis-2'),
      ('pat-3', 'Гаврилова Алиса Ярославовна', '2010-12-10', 'Женщина', 'alice@email.com', 'ward-1', 'emp-3', '2025-06-17', 'dis-4'),
      ('pat-4', 'Козлова Анна Сергеевна', '1968-11-22', 'Женщина', 'kozlova@email.com', 'ward-2', 'emp-4', '2025-06-12', 'dis-7'),
      ('pat-5', 'Белов Михаил Александрович', '1948-07-05', 'Мужчина', '+7-905-555-66-77', 'ward-2', 'emp-5', '2025-06-15', 'dis-8'),
      ('pat-6', 'Иванов Максим Дмитриевич', '2003-12-10', 'Мужчина', '+7-905-111-22-33', 'ward-2', 'emp-6', '2025-06-11', 'dis-10'),
      ('pat-7', 'Кузнецова Елена Викторовна', '1960-02-28', 'Женщина', '+7-911-777-88-99', 'ward-3', 'emp-7', '2025-06-21', 'dis-13'),
      ('pat-8', 'Петрова София Артемовна', '2018-06-10', 'Женщина', '+7-921-999-00-11', 'ward-3', 'emp-8', '2025-06-23', 'dis-14'),
      ('pat-9', 'Летов Егор Дмитриевич', '2003-12-05', 'Мужчина', 'letov@email.com', 'ward-3', 'emp-9', '2025-06-11', 'dis-15'),
      ('pat-10', 'Григорьев Виктор Павлович', '1962-08-12', 'Мужчина', '+7-921-555-77-88', 'ward-4', 'emp-10', '2025-06-13', 'dis-17'),
      ('pat-11', 'Сергеева Ольга Михайловна', '1978-08-22', 'Женщина', 'sergeeva@email.com', 'ward-4', 'emp-11', '2025-06-15', 'dis-17'),
      ('pat-12', 'Леонов Александр Викторович', '1950-12-10', 'Мужчина', '+7-911-666-11-22', 'ward-4', 'emp-12', '2025-06-19', 'dis-18'),
      ('pat-13', 'Сидоров Роман Юрьевич', '1964-05-15', 'Мужчина', '+7-931-888-33-44', 'ward-5', 'emp-13', '2025-06-03', 'dis-21'),
      ('pat-14', 'Андреева Наталья Владимировна', '1976-08-22', 'Женщина', '+7-905-111-44-55', 'ward-5', 'emp-14', '2025-06-22', 'dis-22'),
      ('pat-15', 'Попов Денис Сергеевич', '1962-12-10', 'Мужчина', '+7-911-222-66-77', 'ward-5', 'emp-15', '2025-06-23', 'dis-23');
    `;
